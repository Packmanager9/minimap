    ...
    class Player {
        ...
        ai() {
            ...
            if(this.type == 4){
                ...
                if ((this.units.length > this.racksflag) || this.hotrock*.01 > this.racksflag) {
                    this.racksflag += 5
                    this.racks = 0
                }
                                ...
                                if(this.seenrocks[k].builtOn == 0 && this.seenrocks[k].occupied == false){
                                    ...
                                    if(this.path.length > 0){
                                        ...
                                        for(let p = 0;p<this.path.length;p++){
                                            if(this.path[p].slime == 1)[
                                                discount-=5
                                            ]
                                        }

                                        if(((this.path.length*5)+discount) <= this.hotrock && ((this.path.length*5)+discount)  < 170){ //cost to build new sporeball
                                            for(let p = 0;p<this.path.length;p++){
                    ...
                    for (let t = 0; t < this.buildings.length; t++) {
                        if (this.buildings[t].slime == 1) {
                            if (Math.random() < .5) {
                                ...
                                if (this.hotrock > 30+(this.buildings.length*5) || this.seenrocks.length <= this.units.length) {
                                    this.buildings[t].makeFruitingbuddy()
                                    if(Math.random()<.1){
                                        break
                                    }
            ...
            if (true) {
                ...
                if (this.slime == 1) {
                    ...
                    if (dataflop == 0) {
                        canvas_context.fillStyle = "white"
                        canvas_context.font = "12px arial"
                        canvas_context.fillText("Buddy: 30", this.spawnsmall.x + 1, this.spawnsmall.y + 46)
